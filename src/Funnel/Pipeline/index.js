...
export default class Pipeline extends React.Component {
    ...
    _constructPolygon(points, attributes) {
        ...
        return Pipeline.createSVGElement('polygon', computedAttributes);
    }
    ...
    _constructOuterPolygon(svgDimensions, bandPercentageHeightPadding, rightOuterBandPadding) {
        ...
        let animationEl = Pipeline.createSVGElement('animate', {
    ...
    _constructPartitions(svgDimensions) {
        ...
        for (let index = 0; index < bandCount; index++) {
            ...
            partitions.push(Pipeline.createSVGElement('path', {
    ...
    _constructInnerBandValues(svgDimensions) {
        ...
        for (let index = 0; index < bandCount; index++) {
            ...
            let textEl = Pipeline.createSVGElement('text', {
                x: xOffset,
     ...
     */
    render() {
        return (<div className="funnelChart">
            <svg className="funnelChart__svg" ref="svgElement" ref="chartElement"></svg>
        </div>);
    }
